...
public class	Taxi
	...
	public final ArrayList<Fahrt>	getFahrtList ()
		{
		return fahrtList;
		}

	public final void	setFahrtList (ArrayList<Fahrt> fahrtList)
		{
	...
	public 	Taxi
		...
		{
		this (modell, nummer, aChauffeur, null, new ArrayList<Fahrt> (), 0);
		}
	...
	public String	toString ()
		...
		ArrayList<Fahrt> al = getFahrtList ();
		s = s + "\n Fahrten-ArrayList: " + al;
		if (al != null)
			{
			i = 0;
			for (Fahrt ff : al)
