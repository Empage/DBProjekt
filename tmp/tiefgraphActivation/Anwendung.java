...
public class	Anwendung
	...
	public static void	findeObjekte ()
		...
		DB.zeigeResultat (resultat);
		System.out.println ();
		System.out.println ("Aktivierung bis Tiefe 1 von Fahrt und FahrtList:");
		getDb ().activate (resultat.get (0).getFahrt (), 1);
		getDb ().activate (resultat.get (0).getFahrtList (), 1);
		DB.zeigeResultat (resultat);
